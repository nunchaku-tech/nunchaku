...
controlnet_union = FluxControlNetModel.from_pretrained(controlnet_model_union, torch_dtype=torch.bfloat16 , cache_dir=cache_dir)
...
pipeline = FluxControlNetPipeline.from_pretrained(
    base_model, transformer=transformer, controlnet=controlnet, torch_dtype=torch.bfloat16, cache_dir = cache_dir
).to("cuda")


prompt = "A girl with messy beach waves."
