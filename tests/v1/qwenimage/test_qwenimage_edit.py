    ...
    [
        pytest.param(
            TestCase(
                ...
                rank=32,
                expected_lpips={"int4": 0.35, "fp4": 0.3},
            ),
        ...
        pytest.param(
            TestCase(
                ...
                num_inference_steps=4,
                rank=128,
                expected_lpips={"int4": 0.32, "fp4": 0.3},
            ),
        ...
        pytest.param(
            TestCase(
                ...
                rank=32,
                expected_lpips={"int4": 0.4, "fp4": 0.3},
            ),
            id="qwen-image-lightning-8steps-r32",
        ),
        pytest.param(
            TestCase(
                model_name="qwen-image-lightningv1.1-8steps",
            ...
            id="qwen-image-lightning-8steps-r128",
        ),
    ],
)
def test_qwenimage_lightning(case: TestCase):
